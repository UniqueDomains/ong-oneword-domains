# Available .ONG One-Word Domains (9,600)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C601%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C600%20domains-6f42c1">
  <img alt="formats" src="https://img.shields.io/badge/formats-CSV%20%7C%20JSON-f59e0b">
  <img alt="license" src="https://img.shields.io/badge/license-see%20LICENSE-6b7280">
</p>

Daily-updated dataset of available and resale .ong one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 9,601 rows · **Live catalog:** 9,600 domains
...
- `ong.csv` — public CSV extract (9,601 rows)
- `ong.json` — public JSON extract (9,601 rows)
...
| free.ong       | premium   | $62.50    | $31.25        | 88             | 57     | 4      | name.com                    |
| outlook.ong    | available | $16.99    | —             | 77             | 72     | 7      | name.com                    |
| eve.ong        | resell    | —         | —             | 78             | 41     | 3      | Instra Corporation Pty Ltd. |
| data.ong       | premium   | $650      | $325          | 70             | 56     | 4      | namecheap                   |
...
| true.ong       | available | $16.99    | $16.99        | 86             | 52     | 4      | name.com                    |
...
| ----------------------- | ------------------------------------------------ |
| 9,601-row public sample | 9,600 live domains                               |
