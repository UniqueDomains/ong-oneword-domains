...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C600%20rows-8250df">
...
- `ong.csv` — public CSV extract (9,600 rows)
- `ong.json` — public JSON extract (9,600 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,600-row public sample | 9,600 live domains                               |
